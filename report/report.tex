...
\centering
\makebox[\textwidth][c]{
	\includegraphics[width=1.0\textwidth]{gaussian-mixture-laplace-terms.eps}
}
...
%\end{equation*}
%for more points $x_i$ and the algorithm will gradually start selecting other points.
...
\centering
\makebox[\textwidth][c]{
	\includegraphics[width=0.8\textwidth]{lotka-volterra-trace-plots.eps}
}
