...
The results of applying Stein thinning are shown in Figure~\ref{fig:lotka-volterra:stein:results} in the Appendix.
...
\centering
\makebox[\textwidth][c]{
	\includegraphics[width=.6\textwidth]{lotka-volterra-naive-thinning.png}
}
...
\centering
\makebox[\textwidth][c]{
	\includegraphics[width=.6\textwidth]{lotka-volterra-stein-thinning.png}
}
\caption{Results of Stein thinning of the sample from the Lotka-Volterra model.
