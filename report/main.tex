...
The validation sample we use for calculating the energy distance in this case was obtained by running the HMC algorithm with the starting points shown in \Cref{table:lotka-volterra:starting_values} for 10,000 steps and concatenating the results for the five chains.
